...
**89 issues — 82 closed (92%), 7 open.**
**Closed (cumulative): 82.** ← integer total of all closed issues ever, including
...
| Bucket | Count | Issues |
|---|---|---|
| **Ready (agent)** — loop-eligible | 3 | #210 #215 #216 |
...
Open by wave: W4 1 (#196) · W5 3 (#210 #215 #216) · cross-cutting 3 (#99 #207 bench#7).
