...
| --- | ------ | ----- | ---------------------------------- |
| PR #6 | skrabe | MERGED (lcc main `f1db0de`; 2026-06-10) | **Fable 5 override set for CC 2.1.170** (companion to tf PR #7). Merged-mains gate re-run green → 2.1.170 finalized (#94 step 3). |
